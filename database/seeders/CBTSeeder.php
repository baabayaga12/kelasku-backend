...
class CBTSeeder extends Seeder
{
    ...
    Schema::enableForeignKeyConstraints();
        ...
        $q1 = Question::create([
            'id' => (string) Str::uuid(),
            'test_id' => $test1->id,
            'question' => 'Permukaan bumi yang menjulang tinggi disebut?',
            'stimulus' => null,
            'stimulus_type' => null,
        ...
        $q2 = Question::create([
            'id' => (string) Str::uuid(),
            'test_id' => $test1->id,
            'question' => 'Berdasarkan gambar di atas, bentuk kenampakan alam apakah yang ditunjukkan?',
        ...
        $q4 = Question::create([
            'id' => (string) Str::uuid(),
            'test_id' => $test2->id,
            'question' => 'Perhatikan gambar di atas! Berapakah luas bangun datar tersebut?',
        ...
        $q5 = Question::create([
            'id' => (string) Str::uuid(),
            'test_id' => $test3->id,
            'question' => 'Berdasarkan cerita di atas, siapa tokoh utama dalam cerita?',
        ...
        $q6 = Question::create([
            'id' => (string) Str::uuid(),
            'test_id' => $test3->id,
            'question' => 'Perhatikan gambar di atas! Apa gagasan utama dari paragraf tersebut?',
        ...
        $q7 = Question::create([
            'id' => (string) Str::uuid(),
            'test_id' => $test4->id,
            'question' => 'Perhatikan gambar di atas! Bagian yang ditunjuk oleh huruf A berfungsi untuk...',
        ...
        $q9 = Question::create([
            'id' => (string) Str::uuid(),
            'test_id' => $test5->id,
            'question' => 'Perhatikan gambar Pancasila di atas! Sila yang ditunjuk oleh nomor 1 berbunyi...',
